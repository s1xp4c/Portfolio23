...
const Contact = () => {
  ...
  const inputClassName = `bg-tertiary py-4 px-6 placeholder:text-secondary rounded-lg font-medium w-full ${
    focused ? "draw bg-transparent" : ""
  }`;
    ...
    >
      ...
      >
        ...
        >
          ...
          <button
            type="submit"
            className="bg-tertiary py-3 px-8 rounded-xl outline-none w-fit text-white font-bold shadow-md shadow-primary w-full border-1 "
          >
